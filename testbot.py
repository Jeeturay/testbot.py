...
async def ownerinfo(ctx):
    ...
    embed.set_author(name=" Bot OwnerName- @jaffa#5459,")
...
You can check our current prices in the #buy-points😉👈👈  channel!

**__What do you want to buy?
Instant points or deluxe?__**
